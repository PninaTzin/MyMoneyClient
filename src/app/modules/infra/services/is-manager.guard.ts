  ...
  canActivate(
    ...
    state: RouterStateSnapshot): Observable<boolean | UrlTree> | Promise<boolean | UrlTree> | boolean | UrlTree {
      // if(this.authService.getPermissionType()==1||this.authService.getPermissionType()==5||this.authService.getPermissionType()==2){
        if(this.authService.getPermissionType()==userType.systemAdministrator||this.authService.getPermissionType()==userType.lendersManager||this.authService.getPermissionType()==userType.lender){
        return true;
      }
